(function($) {
	...
	const downloadInput = document.querySelector('#download-form > input:nth-of-type(1)');
	const downloadElem = document.querySelector('#hdn-dwnld-lnk');
	if (downloadForm && downloadInput && downloadElem) {
